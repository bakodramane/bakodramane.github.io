...
1. Édition et détection d'erreurs de données
...
2. Nettoyage et imputation des données
...
5. Apprentissage automatique et IA pour l'analyse, la pondération et l'estimation des données d'enquête
...
6. IA dans les rapports d'enquête, la visualisation et la diffusion des données
...
7. IA dans la méthodologie d'enquête
...
8. IA dans les statistiques officielles et les enquêtes auprès des ménages
